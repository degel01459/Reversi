...
def jugadadiagizqinf(board,f,c,jug):
	...
	return board
"""
def jugadaizq(tablero,cord1,cord2,player):
...
def jugadadiagizqsup(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
...
def jugadasup(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
...
def jugadadiagdersup(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
...
def jugadader(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
...
def jugadadiagderinf(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
...
def jugadainf(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
...
def jugadadiagizqinf(tablero,cord1,cord2,player):
	if cord1<0 or cord1>=8 or cord2<0 or cord2>=8 or tablero[cord1][cord2]==player.j:
		pass
	elif tablero[cord1][cord2]!=player.j and 0<=cord1<8 and 0<=cord2<8 and tablero[cord1][cord2]!=0:
